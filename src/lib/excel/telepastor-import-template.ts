...
const SAMPLE_ROWS = [
  ...
  {
    [TELEPASTOR_IMPORT_TEMPLATE_COLUMNS.name]: "Yaw Boateng",
    [TELEPASTOR_IMPORT_TEMPLATE_COLUMNS.phone]: "0244111002",
    [TELEPASTOR_IMPORT_TEMPLATE_COLUMNS.address]: "Tema, Ghana",
    [TELEPASTOR_IMPORT_TEMPLATE_COLUMNS.role]: "TELEPASTOR",
...
const INSTRUCTION_ROWS = [
  ...
  [
    "Leader Phone",
    "Optional for TELEPASTOR. Leave blank to place the member directly under a Governor.",
  ],
  [
    "Governor Phone",
    "Required for LEADER rows and for TELEPASTOR rows (unless the importer is that Governor/Leader).",
  ],
  [],
  ["Who can import"],
  ...
  [
    "Governor",
    "Can import Leaders under self and Telepastors under self (Leader optional).",
  ],
  ["Leader", "Can import Telepastors assigned to themselves only."],
  [],
  ["Assignment after import"],
  [
    "Governors",
    "Can distribute lists to Leaders and to Telepastors with no Leader.",
  ],
  [
    "Leaders",
    "Can distribute lists only to Telepastors assigned to them.",
  ],
